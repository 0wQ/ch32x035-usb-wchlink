...
target("firmware")
    ...
    add_files("src/main.c", "src/bsp/bsp_delay.c", "src/bsp/bsp_system.c", "src/bsp/bsp_uid.c", "src/drv/*.c", "src/usb/bsp_usb.c", "src/wchlink/status/*.c", "src/wchlink/transport/*.c", "src/wchlink/rvswd/*.c", "src/wchlink/flash/*.c", "src/wchlink/flash/*.S", "src/wchlink/target/*.c", "src/wchlink/session/*.c", "src/wchlink/protocol/*.c", "src/wchlink/usb/*.c", "sdk/Startup/startup_ch32x035_highcode.S")
