...
target("firmware")
    ...
    add_files("src/main.c", "src/bsp/bsp_delay.c", "src/bsp/bsp_system.c", "src/bsp/bsp_uid.c", "src/drv/*.c", "src/usb/bsp_usb.c", "src/wchlink/rvswd/*.c", "src/wchlink/rvswd/*.S", "src/wchlink/target/*.c", "src/wchlink/protocol/*.c", "src/wchlink/usb/*.c", "sdk/Startup/startup_ch32x035_highcode.S")
    ...
    add_includedirs("src", "src/wchlink/rvswd", "src/wchlink/target", "src/wchlink/protocol", "src/wchlink/usb", "src/usb", "sdk/Core", "sdk/Peripheral/inc", "sdk/System")
